...
#define AWS_IOT_MQTT_CLIENT_ID         "dev_pi_0"      ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME          "AWS-IoT-C-SDK" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "aws_iot_root_ca.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "1be5b7ba65-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "1be5b7ba65-private.pem.key" ///< Device private key filename
// =================================================
